                    ...
                    <div class="sm:flex sm:mt-8">
                        <div class="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-evenly">
                            <div class="flex flex-col">
                                <span class="font-bold text-gray-700 uppercase mb-2">ADDRESS</span>
                                <p>FBIV Infocomm Pvt. Ltd.</p>
                                <p>D-2/6 Krishna Nagar, </p>
                                <p>East Delhi,</p>
                                <p> Delhi-110051</p>
                            </div>
                            <div class="flex flex-col">
                                <span class="font-bold text-gray-700 uppercase mt-4 md:mt-0 mb-2">E-Mail </span>
                                <p>  info@vfast.in</p>
                                <span class="my-2"><a href="#" class=" fontServ  text-md hover:text-blue-500">Privacy Policy</a></span>
                            </div>
                            <div class="flex flex-col">
                                <span class="font-bold text-gray-700 uppercase mt-4 md:mt-0 mb-2">Contact No. </span>
                                <p>011 4100 2777 </p>
                                <p>011 4550 2777</p>
